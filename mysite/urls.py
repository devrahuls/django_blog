...
urlpatterns = [
    ...
    #We are using built-in views for all the password related views, also created custom urls to path the views because we already made
    # a path using 'account' url, also made a custom templates to display.
